...
func init() {
	...
	apikeyDescOpenaiForcePriorityTier := apikeyFields[21].Descriptor()
	...
	// groupDescOpenaiLongContextBillingEnabled is the schema descriptor for openai_long_context_billing_enabled field.
	groupDescOpenaiLongContextBillingEnabled := groupFields[31].Descriptor()
	// group.DefaultOpenaiLongContextBillingEnabled holds the default value on creation for the openai_long_context_billing_enabled field.
	group.DefaultOpenaiLongContextBillingEnabled = groupDescOpenaiLongContextBillingEnabled.Default.(bool)
	...
	// paymentorderDescFulfillmentLeaseToken is the schema descriptor for fulfillment_lease_token field.
	paymentorderDescFulfillmentLeaseToken := paymentorderFields[22].Descriptor()
	// paymentorder.FulfillmentLeaseTokenValidator is a validator for the "fulfillment_lease_token" field. It is called by the builders before save.
	paymentorder.FulfillmentLeaseTokenValidator = paymentorderDescFulfillmentLeaseToken.Validators[0].(func(string) error)
