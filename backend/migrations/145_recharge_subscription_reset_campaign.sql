...
CREATE TABLE IF NOT EXISTS recharge_reset_records (
    ...
    CONSTRAINT recharge_reset_records_order_rule_unique UNIQUE (order_id, rule_id),
    CONSTRAINT recharge_reset_records_order_subscription_unique UNIQUE (order_id, subscription_id)
);
...
CREATE INDEX IF NOT EXISTS idx_recharge_reset_records_order ON recharge_reset_records(order_id);
