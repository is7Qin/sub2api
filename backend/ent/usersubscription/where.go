...
func HasRechargeResetRecords() predicate.UserSubscription {
	return predicate.UserSubscription(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRechargeResetRecordsWith(preds ...predicate.RechargeResetRecord) predicate.UserSubscription {
	return predicate.UserSubscription(func(s *sql.Selector) {
