...
var ProviderSet = wire.NewSet(
	...
	NewAffiliateService,
	NewRechargeResetCampaignService,
...
// ProvidePaymentService creates PaymentService and attaches optional fulfillment integrations.
func ProvidePaymentService(entClient *dbent.Client, registry *payment.Registry, loadBalancer payment.LoadBalancer, redeemService *RedeemService, subscriptionSvc *SubscriptionService, configService *PaymentConfigService, userRepo UserRepository, groupRepo GroupRepository, affiliateService *AffiliateService, rechargeResetService *RechargeResetCampaignService, notificationEmailService *NotificationEmailService) *PaymentService {
	svc := NewPaymentService(entClient, registry, loadBalancer, redeemService, subscriptionSvc, configService, userRepo, groupRepo, affiliateService)
	svc.SetRechargeResetCampaignService(rechargeResetService)
	svc.SetNotificationEmailService(notificationEmailService)
	return svc
}
