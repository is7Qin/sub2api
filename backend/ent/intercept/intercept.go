...
// The LotteryCampaignFunc type is an adapter to allow the use of ordinary function as a Querier.
type LotteryCampaignFunc func(context.Context, *ent.LotteryCampaignQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f LotteryCampaignFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.LotteryCampaignQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.LotteryCampaignQuery", q)
}

// The TraverseLotteryCampaign type is an adapter to allow the use of ordinary function as Traverser.
type TraverseLotteryCampaign func(context.Context, *ent.LotteryCampaignQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseLotteryCampaign) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseLotteryCampaign) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.LotteryCampaignQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.LotteryCampaignQuery", q)
}

// The LotteryChanceFunc type is an adapter to allow the use of ordinary function as a Querier.
type LotteryChanceFunc func(context.Context, *ent.LotteryChanceQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f LotteryChanceFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.LotteryChanceQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.LotteryChanceQuery", q)
}

// The TraverseLotteryChance type is an adapter to allow the use of ordinary function as Traverser.
type TraverseLotteryChance func(context.Context, *ent.LotteryChanceQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseLotteryChance) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseLotteryChance) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.LotteryChanceQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.LotteryChanceQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.LotteryCampaignQuery:
		return &query[*ent.LotteryCampaignQuery, predicate.LotteryCampaign, lotterycampaign.OrderOption]{typ: ent.TypeLotteryCampaign, tq: q}, nil
	case *ent.LotteryChanceQuery:
		return &query[*ent.LotteryChanceQuery, predicate.LotteryChance, lotterychance.OrderOption]{typ: ent.TypeLotteryChance, tq: q}, nil
