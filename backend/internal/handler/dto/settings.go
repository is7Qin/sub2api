...
// OpenAICodexUAProfile is the structured admin view of the global Codex UA setting.
...
type SystemSettings struct {
	...
	OpenAICodexUAProfile               OpenAICodexUAProfile `json:"openai_codex_ua_profile"`
