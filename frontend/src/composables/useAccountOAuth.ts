...
export type AuthInputMethod = 'manual' | 'cookie' | 'refresh_token' | 'mobile_refresh_token' | 'session_token' | 'access_token' | 'agent_identity' | 'codex_session' | 'personal_access_token'
