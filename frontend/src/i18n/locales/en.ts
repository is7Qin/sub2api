export default {
  ...
  availableChannels: {
    ...
    modelSearchPlaceholder: 'Search models in this channel...',
    modelCount: '{count} models',
    priceInput: 'Input',
    priceOutput: 'Output',
    priceCacheRead: 'Cache read',
    priceCacheWrite: 'Cache write',
    pricePerRequest: 'Per req',
    priceImage: 'Per image',
    priceTiered: 'Tiered',
    perMillionHint: 'Prices in USD per 1M tokens',
    modelColumn: 'Model',
    billingColumn: 'Billing',
    noModelsInChannel: 'No models in this channel',
  ...
  admin: {
    ...
    users: {
      ...
      apiKeyConcurrency: 'Key concurrency limit',
      apiKeyConcurrencyHint: '0 removes only this key-specific ceiling. Requests still share the user concurrency limit.',
      apiKeyConcurrencyInvalid: 'Key concurrency must be an integer from 0 to 2147483647.',
      apiKeyConcurrencyUpdated: 'Key concurrency updated successfully',
      apiKeyConcurrencyUpdateFailed: 'Failed to update key concurrency',
    ...
    subscriptions: {
      ...
      switchSubscriptionGroup: 'Switch Subscription Group',
      ...
      switchingFor: 'Switching subscription for',
      switchGroupHint: 'Usage counters are kept when switching groups',
      ...
      subscriptionSwitched: 'Subscription group switched successfully',
      ...
      failedToSwitch: 'Failed to switch subscription group',
      ...
      guide: {
        ...
        actions: {
          ...
          switchGroup: 'Switch',
          switchGroupDesc: 'Change the subscription group while keeping usage counters',
          resetQuota: 'Reset Quota',
    ...
    accounts: {
      ...
      antigravityProjectIdHint:
        'Use this for Antigravity standard-tier OAuth accounts that did not receive an automatic project_id.',
      status: {
        active: 'Active',
        inactive: 'Inactive',
        error: 'Error',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        refreshPlanType: 'Refresh Plan Type',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        refreshPlanTypeSuccess: 'Successfully refreshed {count} account(s) plan type',
      ...
      openai: {
        ...
        codexImageGenerationBridgeDisabled: 'Disable auto-injection',
        codexImageGenerationBridgeDisabledDesc: 'Do not inject an image tool, but preserve client-provided image tools.',
        codexImageGenerationBridgeBlock: 'Block completely',
        codexImageGenerationBridgeBlockDesc: 'Remove client-provided image tools and any tool_choice that selects them.',
        codexImageGenerationBridgeBadgeInherit: 'Channel policy',
        codexImageGenerationBridgeBadgeEnabled: 'Account on',
        codexImageGenerationBridgeBadgeDisabled: 'Injection off',
        codexImageGenerationBridgeBadgeBlock: 'Fully blocked',
    ...
    ops: {
      ...
      diagnosis: {
        ...
        // Billing outbox worker diagnostics
        circuitBreakerOpen: 'Billing circuit breaker open',
        circuitBreakerOpenImpact: 'Billing apply claims are paused until cooldown probe recovers. New billing writes still enqueue.',
        circuitBreakerOpenAction: 'Check last_error on the billing worker card and the outbox ops doc for recovery.',
        terminalAlert: 'Billing terminal rows growing above threshold',
        terminalAlertImpact: 'Systematic permanent errors are being terminalized (e.g. schema break).',
        terminalAlertAction: 'Check billing-outbox/health stats_error and the terminal recovery SQL.',
        billingLagCritical: 'Billing oldest lag over {lag}h',
        billingLagCriticalImpact: 'Fee deduction is delayed for records waiting in the outbox queue.',
        billingLagCriticalAction: 'Monitor pending backlog on the billing worker card; lag ≈ backlog / drain rate.',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigningHint: 'Deprecated compatibility setting. The value is saved and returned, but forwarded billing headers no longer include or sign cch.',
      ...
      openai403Cooldown: {
        ...
        thresholdPauseSeconds: 'Threshold Pause (seconds)',
      ...
      openaiOAuth429Dynamic: {
        ...
        planTypeDuplicate: 'Plan Type must be unique',
        planTypeLimit: 'A maximum of 100 Plan Type policies is allowed',
