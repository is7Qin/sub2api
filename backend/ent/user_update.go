...
func (_u *UserUpdate) AddLotteryDrawIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddLotteryDrawIDs(ids...)
	return _u
}

// AddLotteryDraws adds the "lottery_draws" edges to the LotteryDraw entity.
func (_u *UserUpdate) AddLotteryDraws(v ...*LotteryDraw) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) AddRechargeResetRecordIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddRechargeResetRecords(v ...*RechargeResetRecord) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearLotteryDraws clears all "lottery_draws" edges to the LotteryDraw entity.
func (_u *UserUpdate) ClearLotteryDraws() *UserUpdate {
	_u.mutation.ClearLotteryDraws()
	return _u
}

// RemoveLotteryDrawIDs removes the "lottery_draws" edge to LotteryDraw entities by IDs.
func (_u *UserUpdate) RemoveLotteryDrawIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveLotteryDrawIDs(ids...)
	return _u
}

// RemoveLotteryDraws removes "lottery_draws" edges to LotteryDraw entities.
func (_u *UserUpdate) RemoveLotteryDraws(v ...*LotteryDraw) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearRechargeResetRecords() *UserUpdate {
...
func (_u *UserUpdate) RemoveRechargeResetRecordIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveRechargeResetRecords(v ...*RechargeResetRecord) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.LotteryDrawsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedLotteryDrawsIDs(); len(nodes) > 0 && !_u.mutation.LotteryDrawsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.LotteryDrawsTable,
	...
	if nodes := _u.mutation.LotteryDrawsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.LotteryDrawsTable,
	...
	if _u.mutation.RechargeResetRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.RechargeResetRecordsTable,
			Columns: []string{user.RechargeResetRecordsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddLotteryDrawIDs adds the "lottery_draws" edge to the LotteryDraw entity by IDs.
func (_u *UserUpdateOne) AddLotteryDrawIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddLotteryDrawIDs(ids...)
	return _u
}

// AddLotteryDraws adds the "lottery_draws" edges to the LotteryDraw entity.
func (_u *UserUpdateOne) AddLotteryDraws(v ...*LotteryDraw) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddRechargeResetRecordIDs adds the "recharge_reset_records" edge to the RechargeResetRecord entity by IDs.
func (_u *UserUpdateOne) AddRechargeResetRecordIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddRechargeResetRecordIDs(ids...)
	return _u
}

// AddRechargeResetRecords adds the "recharge_reset_records" edges to the RechargeResetRecord entity.
func (_u *UserUpdateOne) AddRechargeResetRecords(v ...*RechargeResetRecord) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearLotteryDraws clears all "lottery_draws" edges to the LotteryDraw entity.
func (_u *UserUpdateOne) ClearLotteryDraws() *UserUpdateOne {
	_u.mutation.ClearLotteryDraws()
	return _u
}

// RemoveLotteryDrawIDs removes the "lottery_draws" edge to LotteryDraw entities by IDs.
func (_u *UserUpdateOne) RemoveLotteryDrawIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveLotteryDrawIDs(ids...)
	return _u
}

// RemoveLotteryDraws removes "lottery_draws" edges to LotteryDraw entities.
func (_u *UserUpdateOne) RemoveLotteryDraws(v ...*LotteryDraw) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearRechargeResetRecords clears all "recharge_reset_records" edges to the RechargeResetRecord entity.
func (_u *UserUpdateOne) ClearRechargeResetRecords() *UserUpdateOne {
	_u.mutation.ClearRechargeResetRecords()
	return _u
}

// RemoveRechargeResetRecordIDs removes the "recharge_reset_records" edge to RechargeResetRecord entities by IDs.
func (_u *UserUpdateOne) RemoveRechargeResetRecordIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveRechargeResetRecordIDs(ids...)
	return _u
}

// RemoveRechargeResetRecords removes "recharge_reset_records" edges to RechargeResetRecord entities.
func (_u *UserUpdateOne) RemoveRechargeResetRecords(v ...*RechargeResetRecord) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
