...
func TestSettingHandler_GetPublicSettings_ExposesChannelMonitorRuntimeContract(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.NoError(t, json.Unmarshal(recorder.Body.Bytes(), &resp))
	require.Equal(t, service.ChannelMonitorModeV2, resp.Data.ChannelMonitorMode)
	require.False(t, resp.Data.ChannelMonitorHideThroughput)
}
