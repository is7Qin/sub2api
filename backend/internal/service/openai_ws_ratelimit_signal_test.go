...
func (r *openAICodexExtraListRepo) ListWithFilters(_ context.Context, params pagination.PaginationParams, _ AccountListFilters) ([]Account, *pagination.PaginationResult, error) {
...
func TestAdminService_ListAccounts_ExhaustedCodexExtraDoesNotSetRateLimit(t *testing.T) {
	...
	accounts, total, err := svc.ListAccounts(context.Background(), 1, 20, AccountListFilters{Platform: PlatformOpenAI, AccountType: AccountTypeOAuth}, "", "")
	require.NoError(t, err)
