...
type UserEdges struct {
	...
	// RankingRewardExclusions holds the value of the ranking_reward_exclusions edge.
	RankingRewardExclusions []*RankingRewardExcludedUser `json:"ranking_reward_exclusions,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) LotteryDrawsOrErr() ([]*LotteryDraw, error) {
	if e.loadedTypes[4] {
...
// RankingRewardExclusionsOrErr returns the RankingRewardExclusions value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RankingRewardExclusionsOrErr() ([]*RankingRewardExcludedUser, error) {
	if e.loadedTypes[5] {
		return e.RankingRewardExclusions, nil
	}
	return nil, &NotLoadedError{edge: "ranking_reward_exclusions"}
}

// RankingRewardAwardsOrErr returns the RankingRewardAwards value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RankingRewardAwardsOrErr() ([]*RankingRewardAward, error) {
	if e.loadedTypes[6] {
...
// was not loaded in eager-loading.
func (e UserEdges) RechargeResetRecordsOrErr() ([]*RechargeResetRecord, error) {
	if e.loadedTypes[15] {
...
// QueryLotteryDraws queries the "lottery_draws" edge of the User entity.
func (_m *User) QueryLotteryDraws() *LotteryDrawQuery {
	return NewUserClient(_m.config).QueryLotteryDraws(_m)
}

// QueryRankingRewardExclusions queries the "ranking_reward_exclusions" edge of the User entity.
func (_m *User) QueryRankingRewardExclusions() *RankingRewardExcludedUserQuery {
	return NewUserClient(_m.config).QueryRankingRewardExclusions(_m)
}

// QueryRankingRewardAwards queries the "ranking_reward_awards" edge of the User entity.
func (_m *User) QueryRankingRewardAwards() *RankingRewardAwardQuery {
	return NewUserClient(_m.config).QueryRankingRewardAwards(_m)
}
...
// QueryRechargeResetRecords queries the "recharge_reset_records" edge of the User entity.
func (_m *User) QueryRechargeResetRecords() *RechargeResetRecordQuery {
	return NewUserClient(_m.config).QueryRechargeResetRecords(_m)
}
