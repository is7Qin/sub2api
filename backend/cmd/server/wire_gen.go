...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	backupHandler := admin.NewBackupHandler(backupService, userService, totpService)
