...
func TestChannelMonitorV2DisplayModelIsPlatformScoped(t *testing.T) {
	cfg := service.ChannelMonitorV2Config{Platforms: []service.ChannelMonitorV2PlatformConfig{
		...
		{Platform: "kiro", Enabled: true, Models: []string{"claude-opus-4-8"}},
	...
	require.Equal(t, service.ChannelMonitorV2OtherModel, channelMonitorV2DisplayModel(cfg, "kiro", "shared"))
	...
	require.True(t, channelMonitorV2ModelSelected(service.ChannelMonitorV2Filter{Models: []string{service.ChannelMonitorV2OtherModel}}, cfg, "kiro", "shared"))
}
...
func TestChannelMonitorV2WhereUsesConfiguredScopeAndEmptyFilterMeansAllConfigured(t *testing.T) {
	...
	cfg := service.ChannelMonitorV2Config{
		Platforms: []service.ChannelMonitorV2PlatformConfig{{Platform: "openai", Enabled: true}, {Platform: "kiro", Enabled: false}},
		GroupIDs:  []int64{3, 4},
	}
...
func TestChannelMonitorV2UsageSuccessExcludesCyberBillingRows(t *testing.T) {
	...
	require.Contains(t, channelMonitorV2PlatformSQL, "g.platform")
