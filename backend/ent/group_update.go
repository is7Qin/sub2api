...
func (_u *GroupUpdate) SetOpenaiLongContextBillingEnabled(v bool) *GroupUpdate {
	_u.mutation.SetOpenaiLongContextBillingEnabled(v)
	return _u
}
...
func (_u *GroupUpdate) SetNillableOpenaiLongContextBillingEnabled(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetOpenaiLongContextBillingEnabled(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.OpenaiLongContextBillingEnabled(); ok {
...
// SetOpenaiLongContextBillingEnabled sets the "openai_long_context_billing_enabled" field.
func (_u *GroupUpdateOne) SetOpenaiLongContextBillingEnabled(v bool) *GroupUpdateOne {
	_u.mutation.SetOpenaiLongContextBillingEnabled(v)
	return _u
}

// SetNillableOpenaiLongContextBillingEnabled sets the "openai_long_context_billing_enabled" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableOpenaiLongContextBillingEnabled(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetOpenaiLongContextBillingEnabled(*v)
	}
	return _u
