...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyFrontendRegionRestrictionEnabled,
	...
	return &PublicSettings{
		...
		FrontendRegionRestrictionEnabled: settings[SettingKeyFrontendRegionRestrictionEnabled] == "true",
...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyFrontendRegionRestrictionEnabled] = strconv.FormatBool(settings.FrontendRegionRestrictionEnabled)
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		// Frontend-only region gate (default disabled; opt-in)
		SettingKeyFrontendRegionRestrictionEnabled: "false",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// Frontend-only region gate (default: disabled; strict true)
	result.FrontendRegionRestrictionEnabled = settings[SettingKeyFrontendRegionRestrictionEnabled] == "true"
