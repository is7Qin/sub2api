...
const (
	...
	// FieldOpenaiForcePriorityTier holds the string denoting the openai_force_priority_tier field in the database.
	FieldOpenaiForcePriorityTier = "openai_force_priority_tier"
...
var (
	...
	// DefaultOpenaiForcePriorityTier holds the default value on creation for the "openai_force_priority_tier" field.
	DefaultOpenaiForcePriorityTier bool
)
...
// ByOpenaiForcePriorityTier orders the results by the openai_force_priority_tier field.
func ByOpenaiForcePriorityTier(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldOpenaiForcePriorityTier, opts...).ToFunc()
}
